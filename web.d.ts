...
declare namespace $ {
	...
	type $mol_text__text_bog_wiki_app_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_page__title_bog_wiki_app_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__body_bog_wiki_app_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body'] >
	>
	type $mol_link_source__uri_bog_wiki_app_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $bog_theme_toggle__theme_auto_bog_wiki_app_5 = $mol_type_enforce<
		ReturnType< $bog_wiki_app['Theme'] >
		,
		ReturnType< $bog_theme_toggle['theme_auto'] >
	>
	type $bog_theme_auto__theme_light_bog_wiki_app_6 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_auto['theme_light'] >
	>
	type $bog_theme_auto__theme_dark_bog_wiki_app_7 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_auto['theme_dark'] >
	>
	type $bog_theme_auto__themes_bog_wiki_app_8 = $mol_type_enforce<
		readonly(any)[]
		,
	...
	>
	export class $bog_wiki_app extends $mol_page {
		Welcome( ): $mol_text
		Home( ): $mol_page
		...
		title( ): string
		pages( ): ({ 
			'home': ReturnType< $bog_wiki_app['Home'] >,
		}) 
		nav_options( ): ({ 
			'home': string,
		}) 
		...
		head( ): readonly(any)[]
		plugins( ): readonly(any)[]
		body( ): ReturnType< $bog_wiki_app['screen_body'] >
	}
